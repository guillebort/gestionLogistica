...
<nav class="navbar navbar-expand-lg sticky-top navbar-admin">
    <div class="container-fluid px-4 py-2">
        ...
        <a class="navbar-brand fw-bold text-white d-flex align-items-center gap-2 m-0" href="index.php">
            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width: 36px; height: 36px; font-size: 1.1rem;">
                ⚙️
            </div>
        ...
        <div class="collapse navbar-collapse" id="navAdmin">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-2 ms-lg-5 text-center text-lg-start mt-3 mt-lg-0 fw-medium">
                <li class="nav-item">
                    <a href="index.php" class="nav-link nav-admin-link <?= ($paginaActual == 'index.php') ? 'active' : '' ?>">📊 Dashboard</a>
                </li>
                <li class="nav-item">
                    <a href="productos.php" class="nav-link nav-admin-link <?= ($paginaActual == 'productos.php') ? 'active' : '' ?>">🏷️ Catálogo</a>
                </li>
                <li class="nav-item">
                    <a href="usuarios.php" class="nav-link nav-admin-link <?= ($paginaActual == 'usuarios.php') ? 'active' : '' ?>">👥 Usuarios</a>
                </li>
                <li class="nav-item">
                    <a href="historialPedidos.php" class="nav-link nav-admin-link <?= ($paginaActual == 'historialPedidos.php') ? 'active' : '' ?>">📦 Envíos</a>
                </li>
                <li class="nav-item">
                    <a href="mensajes.php" class="nav-link nav-admin-link <?= ($paginaActual == 'mensajes.php') ? 'active' : '' ?>">📩 Mensajes</a>
                </li>
            </ul>
